...
import TubeFlix from "../assets/Logo.jpeg";
    ...
    <div className="flex flex-row h-14 px-4 md:px-5 justify-between items-center sticky top-0 z-20 bg-white dark:bg-black shadow-md">
      ...
      <div className="flex h-5 items-center">
        ...
        <Link to="/" className="flex h-5 items-center">
          <img
            src={Logo}
            alt="TubeFlix"
            className="h-full hidden md:block rounded-full"
          />
          <img
            src={TubeFlix}
            alt="TubeFlix"
          ...
          />
          <h2 className="text-xl font-bold text-sky-700 pl-2">Tube Flix</h2>
        </Link>
      </div>
      ...
      <div className="flex items-center">
        ...
        <div className="flex h-8 w-8 overflow-hidden rounded-full md:ml-4">
          <Link to={"https://github.com/ChandraPrakash-Bathula"}>
            <img
              src="https://avatars.githubusercontent.com/u/72041165?v=4"
              alt="Codophile"
            />
          </Link>
        </div>
